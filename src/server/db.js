...
function createMovie(name,stars,year,description,image,review) {
    
    let reviews = []

    const reviewEmpty = {
        title: 'Its great',
        description: 'Lost for words',
        stars: '9'
    }
...
function addExampleMovies() {
    ...
    createMovie("The Hateful Eight",7,2015,"In the dead of a Wyoming winter, a bounty hunter and his prisoner find shelter in a cabin currently inhabited by a collection of nefarious characters.","https://m.media-amazon.com/images/M/MV5BMjA1MTc1NTg5NV5BMl5BanBnXkFtZTgwOTM2MDEzNzE@._V1_UX182_CR0,0,182,268_AL_.jpg",hateful8Array)
